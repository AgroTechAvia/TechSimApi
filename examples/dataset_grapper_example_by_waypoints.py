...
def main(folder_name, capture_frequency, image_prefix, max_images, camera_num):
    ...
    waypoints =[[1,1,454271030,396651808,5000,0,0,0,0],
                [2,1,454272004,396651446,5000,0,0,0,0],
                [3,1,454273472,396643882,5000,0,0,0,165]]
    ...
    while image_count < max_images:
        try:
            result = client.get_camera_capture(camera_id=camera_num, is_clear=True)
