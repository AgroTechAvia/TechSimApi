...
class HighLevelSimClient:
    ...
    def __init__(self):
        ...
        self._pid_yaw = PID(kp=20, ki=0.0, kd=0.4, max_control=1.0, i_limit=None)
        ...
        heigh_pid_processing = lambda x: ((2/(1+(2.7**(-x * 4.125)))) - 1) * 1.7 
        self._pid_height = PID(kp=4.5, ki=0.00, kd=3.5,
